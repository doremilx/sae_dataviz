...
const couleur = {
  ...
  etatsUnis: 'rgba(153, 102, 255, 0.6)',
...
const barChart = new Chart(ctxBar, {
  ...
  data: {
    labels: labelsMois,
    datasets: [
      { label: 'Labubu', data: [(1/53*100),(1/52*100),(1/53*100),(2/39*100),(3/40*100),(3/37*100),(3/37*100),(22/54*100),(40/72*100),(95/133*100),(85/123*100),(45/76*100),(33/63*100)], backgroundColor: '#8E7DB2' },
